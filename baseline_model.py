...
from keras.layers import Dense, Conv2D, MaxPool2D, Dropout, GlobalAveragePooling2D
...
checkpointer = ModelCheckpoint(filepath='models/baseline_model.h5', verbose=1, save_best_only=True)
